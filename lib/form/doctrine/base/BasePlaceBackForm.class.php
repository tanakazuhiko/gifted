...
/**
 * PlaceBack form base class.
 *
 * @method PlaceBack getObject() Returns the current form's model object
 *
 * @package    gifted
 * @subpackage form
 ...
 */
abstract class BasePlaceBackForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('place_back[%s]');
